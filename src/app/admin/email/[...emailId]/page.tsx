...
const EmailDetail = (props: any) => {
  ...
  const keyinfos = EmailConstants.Form.KEYS
  ...
  const [attrs, setAttrs] = useState(EmailConstants.Form.ATTRS)
  ...
  const [rules] = useState({
    ...
    email: [{ required: true, message: ErrorConst.REQUIRED }],
  })
  ...
  return (
    <BasePage className="w-full min-h-[50vw]">
      <div className="w-full p-4 py-8">
        <AdminHeader title={`Email (ID: ${params.emailId})`}>
