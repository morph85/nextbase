...
import ProductConstants from "@/app/admin/product/_sub/constants"
...
const ProductDetail = (props: any) => {
  ...
  const keyinfos = ProductConstants.Form.KEYS
  ...
  const [attrs, setAttrs] = useState(ProductConstants.Form.ATTRS)
  ...
  const [rules] = useState({
    ...
    product: [{ required: true, message: ErrorConst.REQUIRED }],
  })
  ...
  const getData = useCallback(async () => {
    ...
    let response: any = {
      ...
      data: {
        name: "product-new-0",
        description: "Product New 0 Description",
        price: 1.23,
        sort: 2,
        disabled: true,
        content: "<b>hello 123</b><br />hello 456",
      },
    }
  ...
  return (
    <BasePage className="w-full min-h-[50vw]">
      <div className="w-full p-4 py-8">
        <AdminHeader title={`Product (ID: ${params.productId})`}>
